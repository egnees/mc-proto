...
use crate::{
    mc::tests::broadcast::{connection, one_msg, two_msg},
    model::{self, TcpSender},
};
...
struct State {
    senders: BTreeMap<Address, Rc<TcpSender>>,
    msg: BTreeSet<String>,
